...
sleep(5);
echo "\n";
 echo "\e[96m[!] COBAGOCARPAY \n";
 $data5 = '{"promo_code":"COBAGOCARPAY"}';
...
echo "\e[91m [×] Gagal Claim Voucer !";
                ...
                sleep(5);
                echo "\n";
                echo "\e[96m[!] COBAGORIDEPAY \n";
                $data6 = '{"promo_code":"COBAGORIDEPAY"}';
