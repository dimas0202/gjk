...
echo color("green"," Created by : Varathea \n");
...
if($regs->success == true) {
	...
	if($verifs->success == true) {
		...
		echo "\e[96m[!] Claim Voucher GoCar \n";
		$data3 = '{"promo_code":"COBAGOCARPAY"}';
		...
		if($claims->success == true) {
			...
			echo "\e[96m[!] Claim Voucher Goride \n";
			$data4 = '{"promo_code":"COBAGORIDEPAY"}';
			...
			if($claims1->success == true) {
				...
				sleep(5);
				echo "\n";
				echo "\e[96m[!] Claim Voucher Go Food 1 \n";
		...
		sleep(5);
		echo "\n";
		echo "\e[96m[!] Claim Voucher Go Food 2 \n";
		$data6 = '{"promo_code":"GOFOOD02260A"}';
		...
		echo "\n".color("red"," EXP ~> ".$expired9);
		echo "\n".color("green","10] ".$voucher10);
		echo "\n".color("red"," EXP ~> ".$expired10);
		echo"\n";
