...
//	function change(){
        ...
        if(strpos($register, '"otp_token"')){
			...
			if(strpos($verif, '"access_token"')){
				...
				echo "\n".color("green","22. ".$voucher22);
				echo "\n".color("green","23. ".$voucher23);
				echo "\n".color("green","24. ".$voucher24);
				echo "\n".color("green","25. ".$voucher25);
				echo "\n".color("green","26. ".$voucher26);
				echo "\n".color("green","27. ".$voucher27);
				echo "\n".color("green","28. ".$voucher28);
				echo "\n".color("green","29. ".$voucher29);
				echo "\n".color("green","30. ".$voucher30);
				echo "\n".color("green","31. ".$voucher31);
				echo "\n".color("green","32. ".$voucher32);
				echo "\n".color("green","33. ".$voucher33);
				echo "\n".color("green","34. ".$voucher34);
				echo "\n".color("green","35. ".$voucher35);
				echo "\n".color("green","36. ".$voucher36);
				echo "\n".color("green","37. ".$voucher37);
				echo "\n".color("green","38. ".$voucher38);
				echo "\n".color("green","39. ".$voucher39);
				echo "\n".color("green","40. ".$voucher40);
				echo "\n".color("green","41. ".$voucher41);
				echo "\n".color("green","42. ".$voucher42);
				echo "\n".color("green","43. ".$voucher43);
				echo "\n".color("green","44. ".$voucher44);
				echo "\n".color("green","45. ".$voucher45);
				echo "\n".color("green","46. ".$voucher46);
				echo "\n".color("green","47. ".$voucher47);
				echo "\n".color("green","48. ".$voucher48);
				echo "\n".color("green","49. ".$voucher49);
				echo "\n".color("green","50. ".$voucher50);
				echo"\n";
